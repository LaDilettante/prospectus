...
\input{empirical_puzzle}

\section{Stylized Facts}
\input{preliminary_evidence}
\input{anecdote}
...
\input{rd_roadmap}
\input{measuring_spillover}
\input{rd_potential_for_spillover}
\input{rd_private_benefit}
\input{rd_time_horizon}
\input{rd_two_sided_matching}
